        ...
        return (
            <div>
                <form id="pasteForm" onSubmit={this.formSubmitted}>
                    <textarea id="deckPaste" class="modern" autoComplete="off" value={this.state.searchString} onChange={this.searchUpdated}></textarea> <input type="submit" id="loadPaste" value="Load deck paste" />
                </form>
                {error}
            </div>
        )
